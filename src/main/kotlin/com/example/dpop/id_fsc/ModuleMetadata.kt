 ...
 * `id_fsc` exists.
 *
 * The register is reached over ports only - [com.example.dpop.tool_api.PersonDirectory] for the
 * person, [com.example.dpop.tool_api.ActivationCodes] for the Freischaltcode (ADR-31) - never by its
 * own classes: those speak the register's language, the ports ours.
 *
