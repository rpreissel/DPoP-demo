 ...
 * (`auth_password.api.v1`) live here too, reaching the orchestrator through
 * `tool_api.ToolEndpoint`/`AccountDirectory` alone (docs/04-orchestrierung.md #5) -
 * the orchestrator never needs to know `auth_password` exists.
 *
