...
class AuthPasswordLookupToolController(
    ...
    @PostMapping("/orchestrator/api/v1/app/channels/{channelSessionId}/tool-activate/auth-password-lookup")
    ...
    fun activate(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(controllerSupport.applyOutcome(AUTH_PASSWORD_LOOKUP_TOOL_ID, outcome, context))
    }
