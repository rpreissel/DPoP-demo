...
class AuthSmsToolController(
    ...
    @PostMapping("/orchestrator/api/v1/app/channels/{channelSessionId}/tool-activate/auth-sms")
    ...
    fun activate(
        ...
        val context = controllerSupport.beginActivation(channelSessionId, bindingKeyRef, AUTH_SMS_TOOL_ID, ToolCategory.AUTH)
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(controllerSupport.applyOutcome(AUTH_SMS_TOOL_ID, outcome, context))
    }
