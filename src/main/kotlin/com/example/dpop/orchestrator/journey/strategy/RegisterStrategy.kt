...
import com.example.dpop.orchestrator.domain.journey.ANSWER_DECLINE
...
class RegisterStrategy : IntentStrategy<RegisterState> {
     ...
     *
     * Required on BOTH channels because email confirmation is not an enrollment: a confirmed
     * address is account infrastructure and leaves no KNOWLEDGE method behind as a side effect,
     * so the knowledge factor is named outright instead of arriving by accident. Only
